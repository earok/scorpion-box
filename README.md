This is an early work in progress largely based on https://github.com/seanocali/Libretro.NET, which implements Libretro in the .NET framework. Parts of RetroUnityFE are also used to fill some gaps, particular with audio.
